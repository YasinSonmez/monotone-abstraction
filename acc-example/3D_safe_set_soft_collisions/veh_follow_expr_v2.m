function x_plus = veh_follow_expr_v2(x_val, u_val, w_val)
...
% check if a soft-collision occurred
if(x_plus(1) <= 0 && x_plus(2) - x_plus(3) <= con.v_allow)
    x_plus = x_val;
end
