classdef vehicle_occupancy_scenario1 < handle
    ...
    methods
        ...
        function ego_occupancy = vehicle_occupancy_scenario1(s)
        ...
        function is_safe = is_ego_safe(ego_occupancy, oncoming_occupancy)
            % we are unsafe if:
            % 1) the oncoming vehicle cut in front of us, or
            % 2) both vehicles are occupying the intersection simultaneously, or
