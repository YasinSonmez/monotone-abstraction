function con = veh_turn_const_v3()
...
%
% for this scenario, compute the max acceleration
% (still with the worst-case parameter values, though)
Ff_min = con.alpha_max;
con.a_max_ego = (1 / con.M_max) * (con.T_max / con.R_w_max - Ff_min);

% abstraction resolution
con.s_res = 2; % 40 cells
con.s0_res = 2; % 30 cells
