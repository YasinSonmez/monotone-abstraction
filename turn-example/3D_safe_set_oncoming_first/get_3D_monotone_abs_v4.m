function [con, veh_follow_abs] = get_3D_monotone_abs_v4()
...
% (see file veh_follow_expr_v4.m)

veh_follow_dyn = ...
    monotone_dyn(n_x, n_u, n_w, 'veh_turn_expr_v4');
...
% state priorities
x_priority = [1;  % larger ego position more unsafe
              1;  % larger ego velocity more unsafe
              0]; % smaller oncoming position more unsafe
