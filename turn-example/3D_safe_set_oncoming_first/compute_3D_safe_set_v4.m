...
%         v_ego_point = outer_approx_boundary_scenario2(s_point, s0_point);
...
% currently converges after 77 iterations %
tic;
iter = 0;
while(true)
    ...
    for i = 1:veh_turn_abs.basis_size
        ...
        % use max deceleration force for the ego vehicle
        % (veh_follow_expr_4.m ensures max velocity is not exceeded)
        u_idx = 1;
